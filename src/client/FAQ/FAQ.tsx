...
const faq_info =
    <p>
        Welcome to 4chan's <b>F</b>requently <b>A</b>sked <b>Q</b>uestions page. After reading the FAQ, be sure to familiarize yourself with the <Link to='/rules'>Rules!</Link>
    </p>
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="#howpost">How do I post on 4chan?</a></li>
...
const basics =
    <dl>
        <DTStyled className="first" id="what4chan">What is 4chan?</DTStyled>
        <DDStyled>
            <PStyled>4chan is a simple image-based bulletin board where anyone can
        ...
        <DTStyled id="howpost">How do I post on 4chan?</DTStyled>
        <DDStyled>
            <PStyled>In order to post on 4chan you have to do <u><b>one</b></u> of the following:</PStyled>
            <ul>
                <li>If you are a new user of 4chan (i.e., have never posted before), simply wait for 15 minutes before attempting to post. Click &#039;Get Captcha&#039; then wait for the timer to count down. Consider browsing the board in another tab while you wait.</li>
                <li><a href="https://sys.4chan.org/signin">Verify your email address</a> to be able to post immediately.</li>
                <li>Have a <a href="https://www.4chan.org/pass">4chan Pass</a>.</li>
            </ul>
            <PStyled>
                ...
                <br />
                You will need to accept 4chan cookies for any of these methods to work. Please ensure that your browser is not set to block cookies, or that you whitelist 4chan domains in any browser extensions you use which may block cookies. Should you choose to verify your email to bypass the wait, we will not retain long-term records of your email address. After the verification email has been sent, your email address will be purged from our servers.</PStyled>
        </DDStyled>
        ...
        <DDStyled>
            <PStyled>To start a new thread, you must upload an image. 4chan
        ...
        <DDStyled>
            <PStyled>A capcode is a way of verifying someone as a 4chan team member.
                Normal users do not have the ability to post using a capcode. A <a
                    href="#whomod">moderator</a> capcode will display "<span
                        ...
                        <img src="//s.4cdn.org/image/modicon.gif" alt="Mod Icon" title="This user is a 4chan Moderator." style={{ marginBottom: '-3px' }} /></strong></span>"
                after their name. Similarly, the <a href="#whoadmin">administrator</a> capcode
                displays "<span style={{ color: '#FF0000' }}><strong>## Admin <img src="//s.4cdn.org/image/adminicon.gif" alt="Admin Icon" title="This user is the 4chan Administrator." style={{ marginBottom: '-3px' }} /></strong></span>".
                Often times, a moderator will post as
                "<span style={{ color: '#800080' }}><strong>Anonymous ##
                    Mod <img src="//s.4cdn.org/image/modicon.gif" alt="Mod Icon" title="This user is a 4chan Moderator." style={{ marginBottom: '-3px' }} /></strong></span>" in order to keep their identity secret (which
                is policy). <a href="#whojan">Janitors</a> do not receive a
                capcode.</PStyled><br />
            <PStyled><strong>Note:</strong> Icons will always appear alongside a capcode, and will display a tooltip that says "This user is a/the 4chan Moderator/Administrator" upon mousing over them. If there is no icon/tooltip, the poster is
        ...
        <DDStyled>
            <PStyled>Threads expire and are pruned by 4chan's software at a
...
const features =
    <dl>
        ...
        <DTStyled>Where are 4chan's feeds located?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Does 4chan have an official browser extension?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Where is the 4chan Flash archive?</DTStyled>
        <DDStyled>
...
const issues =
    <dl>
        ...
        <DTStyled>Why does 4chan use CAPTCHA?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Why does 4chan think my post is spam?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>What's this "4chan.org" image?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Where should I go if 4chan is unreachable?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Will 4chan remove copyrighted material pursuant to the Digital Millennium Copyright Act (DMCA)?</DTStyled>
        <DDStyled style={{ border: 'none' }}>
...
const administration =
    <dl>
        ...
        <DDStyled>
            <p>Lots of people have contributed to 4chan as volunteers
                ...
                <span style={{ color: '#800080' }}>
                    <strong>Anonymous ## Mod <img src="//s.4cdn.org/image/modicon.gif" alt="Mod Icon" title="This user is a 4chan Moderator." style={{ marginBottom: '-3px' }} /></strong>
        ...
        <DTStyled>Who founded 4chan?</DTStyled>
        <DDStyled>
    ...
    <dl>
        ...
        <DDStyled>
            <p>If you're banned you will be redirected to
                <strong>https://www.4chan.org/banned</strong> when trying to
...
const events =
    <dl>
        <DTStyled>Where does 4chan hold events?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Can I host my own 4chan panel?</DTStyled>
        <DDStyled style={{ border: 'none' }}>
...
const about =
    <dl>
        <DTStyled>When did 4chan open?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>What were 4channel and world4ch?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>Does 4chan sponsor third-party projects?</DTStyled>
        <DDStyled style={{ border: 'none' }}>
...
const technical =
    <dl>
        <DTStyled>What software does 4chan use?</DTStyled>
        <DDStyled>
        ...
        <DTStyled>What hardware does 4chan run on?</DTStyled>
        <DDStyled>
...
const donations =
    <dl>
        ...
        <DTStyled>What keeps 4chan running smoothly?</DTStyled>
        <DDStyled>
